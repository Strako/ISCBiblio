              ...
              <tr bookId="${book.book_id}">
                ...
                <th>
                  <div class="button-container">
                    <button type="button" class="btn btn-outline-primary" role="button" data-toggle="modal" data-target="#editBookModal">
                  ...
                  <div class="button-container">
                    <button type="button" class="btn btn-outline-danger" role="button" data-toggle="modal" data-target="#deleteBookModal">
